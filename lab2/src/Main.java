...
//            System.out.println("whole ");
                        ...
                        for (int k = zLow; k <= zHigh; k++) {
                            if (index.get(i).get(j).containsKey(k)) {
                                if (wholeFile)
                                    ...
                                    for (String line : index.get(i).get(j).get(k)) {
                                        double x = Double.valueOf(line.substring(1, 9));
                                        double y = Double.valueOf(line.substring(11, 19));
                                        double z = Double.valueOf(line.substring(21, 29));
        ...
        System.out.println("Range Query Point Number : "+result.size());
        return result;
    ...
    private static void saveQueryResult(ArrayList<String> result,String[] query) {
        ...
        System.out.println("Result Saved at file : "+filePath+"output\\"+outFileName+suffix);
    }
    ...
    private static void test(){
        ...
        try {
            ...
            while(line !=null){
                if(i%1000000 == 0){
                    System.out.println("Finish tuple: "+i);
                }
                String x = line.substring(1,9);
                String y = line.substring(11,19);
                String z = line.substring(21,29);

                testx.add(Float.valueOf(x));
                testy.add(Float.valueOf(y));
                testz.add(Float.valueOf(z));
    ...
    private static ArrayList<String> testRangeQuery(String[][] rq) {
        ArrayList<String> result = new ArrayList<>();
        ArrayList<String> qx = new ArrayList<>();
        ArrayList<String> qy = new ArrayList<>();
        ArrayList<String> qz = new ArrayList<>();
        float x1,x2,y1,y2,z1,z2;
        x1 = Float.valueOf(rq[0][0]);
        x2 = Float.valueOf(rq[0][1]);
        y1 = Float.valueOf(rq[1][0]);
        y2 = Float.valueOf(rq[1][1]);
        z1 = Float.valueOf(rq[2][0]);
        z1 = Float.valueOf(rq[2][1]);
